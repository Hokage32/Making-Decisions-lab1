...
if((temperature >= 80) && (rain === true)){
  console.log('You need to wear a T-shirt and have a umbrella for this weather')
}else if(temperature <= 80 && temperature >= 60 && rain === true){
  console.log('you need to wear a rain jacket')
}else if(temperature <= 80 && temperature >= 60 && rain === false){
  console.log('you dont need a jacket for today')
}else if(temperature <= 60){
  console.log('Its gonna be cold today, bring a coat')
}
////////// PROBLEM 5 //////////
